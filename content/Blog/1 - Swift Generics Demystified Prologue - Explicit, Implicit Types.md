...
%% ![[Pasted image 20230810222403.png]]
>Ye best start believing in Swift Generics! Yer already using 'em! %%
...
[^1]: In my experience, Xcode will often fail when I click "Show Quick Help", instead of displaying "No Quick Help". If you can find any tips to make Quick Help more reliable, please let me know on [social media](Daniel%20Lyons.md). 
...
[[2 - Swift Generics Demystified - Part 1|Next time]], we start learning about generics in Swift. 